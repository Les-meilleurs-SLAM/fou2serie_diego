 ...
 */
final class Version20191003093804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE duree duree TIME DEFAULT NULL, CHANGE premiere_diffusion premiere_diffusion DATE DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE duree duree TIME DEFAULT \'NULL\', CHANGE premiere_diffusion premiere_diffusion DATE DEFAULT \'NULL\', CHANGE image image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
